                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    <form id="contact" method="post">
                        ...
                        <div class="row">
                                ...
                                <div class="profile-head">
                                    <div class="section-headings">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="name" type="text" value="{{ Auth::user()->username }}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="name" type="text" value="{{ Auth::user()->email }}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="name" type="text" value="{{ Auth::user()->description }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2">
                                <a style="text-decoration: none;" href="editProfile" class="profile-edit-btn" name="btnAddMore">Submit</a><br>
                            </div>
